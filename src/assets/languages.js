export default 
	{
        ...
        types: [
          {
            number: 1,
            content: `Инвестиционные возможности Казахстана.`
          },
          {
            number: 2,
            content: `Риски инвестирования в Казахстане.`
          },
          {
            number: 3,
          ...
          {
            number: 4,
            content: `Рекомендации для инвесторов и защита инвестиций.`
          },
          {
            number: 5,
            content: `Преимущества юрисдикции Международного финансового центра «Астана».`
          },
        ],
			},
			projects: [
        ...
        _package: 'Выберите пакет',
        packages: [
          {
            key: 'Размещение вашего проекта и логотипа в качестве партнера <strong>50€</strong>',
            value: 50,
            data: true,
          },
          {
          ...
          {
            key: 'Размещение вашего инвестиционного проекта, логотипа в качестве партнера на конференции и бегущая строка и живая презентация инвестиционного проекта после выступлений спикеров <strong>200€</strong>',
            value: 200,
            data: false,
          }
        ],
    ...
    en: {
        ...
        types: [
          {
            number: 1,
            content: `Investment opportunities of Kazakhstan`
          },
          {
            number: 2,
            content: `Investment risks in Kazakhstan.`
          },
          {
            number: 3,
          ...
          {
            number: 4,
            content: `Recommendations for investors and investment protection.`
          },
          {
            number: 5,
        ...
        packages: [
          ...
          {
            key: 'Placing of your project and logo as a partner at the conference, running line display and live presentation of the investment project after the speeches of the announcers <strong>200€</strong>',
            value: 200,
            data: false,
          }
        ],
    ...
    cs: {
        ...
        packages: [
          ...
          {
            key: 'Umístění Vašeho projektu a loga jako partnera na konferenci a inzerovaná jako plíživá linie a představení investičního projektu po řeči speakera <strong>200€</strong>',
            value: 200,
            data: false,
          }
        ],
